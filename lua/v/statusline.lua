...
local function colors()
  ...
  local warning_fg = v.style.lsp.colors.warn

  local error_color = v.style.lsp.colors.error
  local info_color = v.style.lsp.colors.info
  ...
  H.all({
    ...
    StCount = { foreground = bg_color, background = indicator_color, bold = true },
