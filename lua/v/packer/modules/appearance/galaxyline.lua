...
local buffer_not_empty = function() return not v.is_buffer_empty() end
local checkwidth = function()
    return v.has_width_gt(40) and buffer_not_empty()
end
...
local bgcolor = function()
  if v.colorscheme == 'nightfly' then
    return '#011627'
  else
    return nil;
  end
...
table.insert(gls.right, {
  ...
  --         return ''
  --       end
  --       if NvimMax.statusline.path == 'relative' then
